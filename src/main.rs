...
async fn main() -> web3::Result<()> {
    ...
    let eth_balance_vs_usd = erc20::get_token_price("ethereum", "usd").await;
    ...
    let list_erc20 = erc20::list_erc20_for_account(address, &settings.get::<String>("etherscan").unwrap()).await;
